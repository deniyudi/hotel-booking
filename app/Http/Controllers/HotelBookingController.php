...
class HotelBookingController extends Controller
{
    ...
    {
        $hotels_bookings = HotelBooking::with('hotel', 'customer')->orderByDesc('id')->paginate(10);

        return view('admin.hotel_bookings.index', compact('hotels_bookings'));
    }
    ...
    public function update(Request $request, HotelBooking $hotelBooking)
    {
        DB::transaction(function () use ($hotelBooking) {
            ...
            $hotelBooking->update(['is_paid' => true,]);
        });
        return redirect()->route('admin.hotel_bookings.index', $hotelBooking);
    }
