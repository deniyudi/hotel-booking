        ...
        <div id="Contact-details" class="bg-white rounded-xl overflow-hidden flex flex-col mx-[18px]">
          <div class="flex p-4 items-center gap-4">
            <button type="button" class="contact-name accordion-button flex items-center gap-2 w-full"
              ...
              <div class="arrow flex shrink-0">
                <img src="{{ asset('assets/images/icons/arrow-up.svg') }}" class="rotate-180 transition-all duration-300"
                  alt="arrow up">
              </div>
            </button>
          </div>
          <div id="accordion-1" class="accordion-content open">
            <div class="email-container flex flex-col gap-2 px-4">
              ...
              <div class="group flex items-center gap-2 p-[12px_16px] border border-[#DCDFE6] rounded-lg overflow-hidden">
                ...
                <input type="email" name="" id=""
                  class="appearance-none outline-none w-full bg-white text-sm font-semibold" value="{{ $user->email }}"
                  readonly>
              </div>
            </div>
            <div class="relative overflow-hidden">
              ...
              <p class="relative z-10 font-medium text-sm leading-[21px] text-white mt-4 p-4 bg-[#4041DA]"><span
                  class="font-bold">NOTE!</span> You will receive important information and also Booking proof in this
                email.</p>
            </div>
          </div>
        </div>
            ...
            <div class="flex flex-1 items-center gap-2">
              <div class="flex shrink-0 group-has-[:invalid]:text-[#757C98]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M13 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22H15C20 22 22 20 22 15V10" stroke="currentColor"
                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M18 8V2L20 4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
