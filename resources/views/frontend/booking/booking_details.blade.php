        ...
        <div class="bg-white flex flex-col p-4 gap-6 rounded-xl mx-[18px]">
          <div id="Header" class="flex items-center justify-between gap-[2px]">
            ...
            @if ($hotelBooking->is_paid)
              <p class="font-semibold text-xs leading-[18px] text-[#F8F8F8] rounded-full bg-[#54A917] p-[6px_12px] w-fit">
                Success</p>
            @else
              <p class="font-semibold text-xs leading-[18px] text-[#F8F8F8] rounded-full bg-[#F98D3F] p-[6px_12px] w-fit">
                Pending</p>
            @endif
          </div>
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col gap-[2px]">
                  ...
                  <div class="flex items-center gap-1">
                    ...
                    <p class="font-medium text-sm leading-[21px] text-[#757C98]">{{ $hotelBooking->hotel->city->name }},
            ...
            <div id="Reservation-details" class="flex flex-col p-4 gap-3">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="flex flex-col gap-[6px]">
                  ...
                  <p class="font-semibold text-sm leading-[21px] text-[#757C98]">02:00 PM</p>
                </div>
