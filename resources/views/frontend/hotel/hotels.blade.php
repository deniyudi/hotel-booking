...
@section('content')
  <section id="content"
    ...
    <div class="relative z-10 px-[18px] flex flex-col gap-6 mt-[60px]">
      ...
      <form method="POST" action="{{ route('frontend.search.hotels') }}"
              ...
              <div class="w-6 h-6 flex shrink-0 group-has-[:invalid]:text-[#757C98]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M16 2V5" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M3.5 9.09009H20.5" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"
              ...
              <div class="w-6 h-6 flex shrink-0 group-has-[:invalid]:text-[#757C98]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                  ...
                  <path
                    ...
                    stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M16.4404 19L17.4304 19.99L19.5604 18.02" stroke="currentColor" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path
