      ...
      <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
        <form method="POST" action="{{ route('admin.hotels.store') }}" enctype="multipart/form-data">
          ...
          <div class="mt-4">
            ...
            <x-text-input id="link_gmaps" class="block mt-1 w-full" type="text" name="link_gmaps" :value="old('link_gmaps')"
          ...
          <div class="mt-4">
            ...
            <x-text-input id="star_level" class="block mt-1 w-full" type="number" name="star_level" :value="old('star_level')"
          ...
          @for ($i = 0; $i < 3; $i++)
            <div class="mt-4">
              ...
              <x-text-input id="photo" class="block mt-1 w-full" type="file" name="photos[]" required autofocus
                autocomplete="photo" />
